...
public class PrimitiveMixer extends SteamMetaTileEntity {
    ...
    public PrimitiveMixer(ResourceLocation metaTileEntityId, boolean isHighPressure) {
        super(metaTileEntityId, GTRMRecipeMaps.PRIMITIVE_MIXER_RECIPES, Textures.MIXER_OVERLAY, isHighPressure);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @NotNull List<String> tooltip,
        ...
        tooltip.add(I18n.format("gtrmcore.machine.primitive_mixer.tooltip"));
    }
