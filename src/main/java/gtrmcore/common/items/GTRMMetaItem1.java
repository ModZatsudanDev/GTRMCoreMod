...
public class GTRMMetaItem1 extends StandardMetaItem {
    ...
    public void registerSubItems() {
        ...
        // steam valves
        STEAM_VALVE = addItem(1001, "valve.steam").setUnificationData(GTRMOrePrefix.valve, GTRMMarkerMaterials.Component.LOW);
        ELECTRIC_STEAM_VALVE = addItem(1002,"valve.electric").setUnificationData(GTRMOrePrefix.valve, GTRMMarkerMaterials.Component.LOW);
        // high steam valves
        HIGH_STEAM_VALVE = addItem(1003, "valve.high_steam").setUnificationData(GTRMOrePrefix.valve, GTRMMarkerMaterials.Component.HIGH);
        ELECTRIC_HIGH_STEAM_VALVE = addItem(1004,"valve.high_electric").setUnificationData(GTRMOrePrefix.valve, GTRMMarkerMaterials.Component.HIGH);
